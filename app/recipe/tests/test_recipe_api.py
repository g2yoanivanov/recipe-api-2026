...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_delete_other_users_recipe_error(self):
        """
        Test deleting amother user's recipe returns an error
        """
        new_user = create_user(
            email='other@example.com',
            password='testpass123'
    ...
    def test_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('3.50'),
            'ingredients': [{'name': 'Bananas'}, {'name': 'Eggs'}],
        }
    ...
    def create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('3.50'),
            'ingredients': [{'name': 'Bananas'}, {'name': 'Oats'}],
        }
    ...
    def test_create_ingredient_on_update(self):
        """
        Test creating an ingredient when creating a recipe
        """
        recipe = create_recipe(user=self.user)
